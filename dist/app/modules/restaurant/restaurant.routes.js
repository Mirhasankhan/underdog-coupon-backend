...
router.post("/create", (0, auth_1.default)(client_1.UserRole.ADMIN), (0, validateRequest_1.default)(restaurant_validation_1.restaurantValidation.restaurantValidationSchema), restaurant_controller_1.restaurantController.createRestaurant);
